...
class StudentPatch(BaseModel):
    ...
    group: Optional[int] = (
        None  ## Do we need this considering we already have group_id? debate reasoning and check back into relationships
    )
    group_id: Optional[int] = None
    semester_id: Optional[int] = None
...
class StudentList(
    BaseModel
):  ## This might be obsolete if its possible to use StudentRead and only retrieve a few specific parts without having to retrieve all the students data.
