...
class Student(Model):
    ...
    id = fields.IntField(
        primary_key=True
    )  ## change variables to id_student etc to be more descriptive
    ...
    semester = fields.ForeignKeyField(
        "models.Semester", related_name="students", null=True, on_delete=fields.SET_NULL
    )
    group = fields.ForeignKeyField(
        "models.Group", related_name="students", null=True, on_delete=fields.SET_NULL
    )
    ...
    def is_archived(
        ...
        bool
    ):  ## Is this redundant?? or error checking. can check student archived_at field to check??
